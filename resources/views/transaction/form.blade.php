                    ...
                    <div class="card-body">
                       <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-2">
                                    <label for="" class="col-12">Inventory <small style="color:red">*</small></label>
                                    <select name="product_id[]" id="" class="form-control" required>
                                        <option value="">Pilih</option>
                                        @foreach($product as $row)
                                            <option value="{{ $row->id }}">{{ $row->name }} ( Stok : {{ number_format($row->qty,0,'.','.') }} )</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" value="{{ auth()->user()->name }}" placeholder="Masukan Nama" class="form-control" name="name" id="" readonly required>
                        </div>
                        <div class="mb-2">
                            <label for="" class="col-12">No Telp <small style="color:red">*</small></label>
                            <input type="text" value="{{ @$data->phone }}" placeholder="Masukan No Telp" class="form-control" name="phone" id="" required>
                        </div>
                        <div class="mb-2">
                            <label for="" class="col-12">Alamat</label>
                            <textarea type="text" value="{{ @$data->address }}" placeholder="Masukan Alamat" class="form-control" name="address" id=""></textarea>
                        </div>
                        <div class="mt-3">
